    ...
    if (delegated) {
      ...
      if (command === "area") {
        emit("area.upsert", args.actor || "unknown", {
          ...
          note: args.note || "",
          goal: args.goal || args.problem || "",
          problem: args.problem || args.goal || "",
        ...
        emit("entity.upsert", args.actor || "unknown", {
          ...
          weight: optionalNumber(args.weight) ?? (args.role === "detail" ? 20 : args.role === "support" ? 50 : 80),
          ...
          evidence: list(args.evidence || args.path),
          covers: list(args.covers || args.id),
